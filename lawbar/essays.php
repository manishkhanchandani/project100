...
mysql_select_db($database_conn, $conn);
$query_rsMyEssays = sprintf("SELECT * FROM law_essays WHERE user_id = %s AND deleted = 0 ORDER BY month_year DESC", $colname_rsMyEssays);
...
<?php if ($totalRows_rsMyEssays > 0) { // Show if recordset not empty ?>
  ...
  <table width="100%" border="1" cellpadding="5" cellspacing="0">
    ...
    <?php do { ?>
      <tr>
        ...
        <td valign="top"><a href="essays_delete.php?essay_id=<?php echo $row_rsMyEssays['essay_id']; ?>">Delete</a></td>
  ...
  <p> Records <?php echo ($startRow_rsMyEssays + 1) ?> to <?php echo min($startRow_rsMyEssays + $maxRows_rsMyEssays, $totalRows_rsMyEssays) ?> of <?php echo $totalRows_rsMyEssays ?>
