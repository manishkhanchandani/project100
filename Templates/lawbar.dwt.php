    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="../lawbar/index.php">Law Bar</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li><a href="../lawbar/team.php">Our Team</a></li>
            <li><a href="../lawbar/about.php">About</a></li>
            <li><a href="../lawbar/contact.php">Contact</a></li>
            <li class="dropdown">
			...
			<li class="dropdown">
              ...
              <ul class="dropdown-menu">
			  	<li><a href="../lawbar/users/auth.php">Login/Logout</a></li>
              </ul>
            </li>
